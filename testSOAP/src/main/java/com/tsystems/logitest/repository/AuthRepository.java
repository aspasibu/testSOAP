...
public interface AuthRepository extends JpaRepository<AuthEvents, Long> {
	...
	@Query("select e,d from AuthEvents e RIGHT OUTER join e.driver d where d.userName=:userName and e.date between :startPeriod and :endPeriod order by e.date asc")
